    ...
    public function init(): self
    {
        return $this
            ...
            ->withProcessorPipeline(function (Pipeline $pipeline): void {
                ...
                $pipeline
                    ->add(new RouteAnnotation\Processors\DTOValidationRulesProcessor())
                    ->add(new RouteAnnotation\Processors\MergeClassInfoProcessor())
                    ->add(new RouteAnnotation\Processors\EnumDescriptionProcessor(descriptionMethod: $this->openapiDocConfig->schema_enum_description_method ?? 'description'))
